...
def defineImgCompare():
  ...
  methodVisitor = classWriter.visitMethod(Opcodes.ACC_PUBLIC | Opcodes.ACC_STATIC, "sqrtSumSquares", "(Lnet/imglib2/IterableInterval;)D", "(Lnet/imglib2/IterableInterval<Lnet/imglib2/type/numeric/RealType<*>;>;)D", None)
  methodVisitor.visitCode()
  label0 = Label()
  methodVisitor.visitLabel(label0)
  ...
  methodVisitor.visitInsn(Opcodes.DCONST_0)
  methodVisitor.visitVarInsn(Opcodes.DSTORE, 2)
  label2 = Label()
  methodVisitor.visitLabel(label2)
  methodVisitor.visitLineNumber(61, label2)
  methodVisitor.visitFrame(Opcodes.F_APPEND,2, ["net/imglib2/Cursor", Opcodes.DOUBLE], 0, None)
  methodVisitor.visitVarInsn(Opcodes.ALOAD, 1)
  methodVisitor.visitMethodInsn(Opcodes.INVOKEINTERFACE, "net/imglib2/Cursor", "hasNext", "()Z", True)
  label3 = Label()
  ...
  methodVisitor.visitVarInsn(Opcodes.DLOAD, 2)
  methodVisitor.visitVarInsn(Opcodes.ALOAD, 1)
  methodVisitor.visitMethodInsn(Opcodes.INVOKEINTERFACE, "net/imglib2/Cursor", "next", "()Ljava/lang/Object;", True)
  methodVisitor.visitTypeInsn(Opcodes.CHECKCAST, "net/imglib2/type/numeric/RealType")
  methodVisitor.visitMethodInsn(Opcodes.INVOKEINTERFACE, "net/imglib2/type/numeric/RealType", "getRealDouble", "()D", True)
  ...
  methodVisitor = classWriter.visitMethod(Opcodes.ACC_PUBLIC | Opcodes.ACC_STATIC, "cosyneSimilarityNorm", "(Lnet/imglib2/IterableInterval;DLnet/imglib2/IterableInterval;D)D", "(Lnet/imglib2/IterableInterval<Lnet/imglib2/type/numeric/RealType<*>;>;DLnet/imglib2/IterableInterval<Lnet/imglib2/type/numeric/RealType<*>;>;D)D", None)
  methodVisitor.visitCode()
  label0 = Label()
  methodVisitor.visitLabel(label0)
  ...
  label5 = Label()
  methodVisitor.visitLabel(label5)
  methodVisitor.visitLineNumber(49, label5)
  methodVisitor.visitFrame(Opcodes.F_FULL, 9, ["net/imglib2/IterableInterval", Opcodes.DOUBLE, "net/imglib2/IterableInterval", Opcodes.DOUBLE, "net/imglib2/Cursor", "net/imglib2/Cursor", Opcodes.DOUBLE, Opcodes.DOUBLE, Opcodes.DOUBLE], 0, [])
  ...
  methodVisitor.visitInsn(Opcodes.DDIV)
  methodVisitor.visitVarInsn(Opcodes.DSTORE, 14)
  label8 = Label()
  methodVisitor.visitLabel(label8)
  ...
  methodVisitor.visitVarInsn(Opcodes.DLOAD, 4)
  methodVisitor.visitInsn(Opcodes.DDIV)
  methodVisitor.visitVarInsn(Opcodes.DSTORE, 16)
  label9 = Label()
  methodVisitor.visitLabel(label9)
  methodVisitor.visitLineNumber(52, label9)
  methodVisitor.visitVarInsn(Opcodes.DLOAD, 8)
  methodVisitor.visitVarInsn(Opcodes.DLOAD, 14)
  methodVisitor.visitVarInsn(Opcodes.DLOAD, 16)
  methodVisitor.visitInsn(Opcodes.DMUL)
  methodVisitor.visitInsn(Opcodes.DADD)
  methodVisitor.visitVarInsn(Opcodes.DSTORE, 8)
  label10 = Label()
  methodVisitor.visitLabel(label10)
  methodVisitor.visitLineNumber(53, label10)
  methodVisitor.visitJumpInsn(Opcodes.GOTO, label5)
  methodVisitor.visitLabel(label6)
  methodVisitor.visitLineNumber(55, label6)
  methodVisitor.visitFrame(Opcodes.F_SAME, 0, None, 0, None)
  methodVisitor.visitVarInsn(Opcodes.DLOAD, 8)
  methodVisitor.visitInsn(Opcodes.DRETURN)
