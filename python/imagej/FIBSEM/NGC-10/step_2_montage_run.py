...
from step_1_montage_parameters import libDir, \
             ...
             params_pixels, paramsSIFT, paramsRANSAC, paramsTileConf, paramsFilterFeatures, \
...
volumeImgMontaged, groupNames, tileGroups = runMontaging(
             ...
             to_remove, ignore_images, replace_images, paramsFilterFeatures=paramsFilterFeatures)
