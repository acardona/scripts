...
# VOLUME
name = "Sam3G_90deg" # Name of the folder containing the .dat files, e.g., "MR1.4-3"
...
# Working canvas
section_width  = 11000      # pixels, after section-wise montaging
section_height = 11000     # So a canvas of 256,000,000 pixels: 256 MB
