...
# VOLUME
name = "MR1.3-1" # Name of the folder containing the .dat files, e.g., "MR1.4-3"
...
section_height = 14000     # So a canvas of 256,000,000 pixels: 256 MB

# Skip sections. Define a range to work with.
first_section = 74  # 0-based
last_section = -1
...
replace_sections = {
  "Merlin-WEMS_24-05-30_104352_": "Merlin-WEMS_24-05-30_104300_",
}
