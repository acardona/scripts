...
frame, table, search_field, all = makeMontageEvaluationTable(groupNames[first_section:last_section+1], tileGroups[first_section:last_section+1], IJ.getImage(), montageDir, show=True)