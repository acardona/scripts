...
propertiesBM = {
 ...
 'n_threads': numCPUs(),
 'roi': None, # [section_width / 6,  # To extract SIFT features from e.g., center part only, reducing ops by 4x
         #section_height / 6, # [x, y, width, height] or None.
         #2 * section_width / 3,
         #2 * section_height / 3],
...
paramsBlockMatching = {
 ...
 'meshResolution': 13, #20, # 10x10 = 100 points
 ...
 'searchRadius': 100, #200, # Maximum expected displacement between slices after SIFT-based registration.
