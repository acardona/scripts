...
propertiesBM = {
 ...
 'n_threads': numCPUs(),
 'roi': [int(section_width / 6),  # To extract SIFT features from e.g., center part only, reducing ops by 4x
         int(section_height / 6), # [x, y, width, height] or None.
         int(section_width / 6 * 4),
         int(section_height / 6 * 4)],
