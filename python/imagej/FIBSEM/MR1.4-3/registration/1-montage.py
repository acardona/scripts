# Step 1: montaging and exporting downscaled images

import sys, os
sys.path.append("/lmb/home/acardona/lab/scripts/python/imagej/IsoView-GCaMP/")
from lib.montage2d import startMontage
from mpicbg.imagefeatures import FloatArray2DSIFT
from ij.gui import Roi


# VOLUME
name = "MR1.4-3" # Name of the folder containing the .dat files, e.g., "MR1.4-3"
...
replace_sections = {
  1750: 1749, # 1750 is missing data at the bottom
  1751: 1752, # 1751 is missing data
  7108: 7107, # 7108 is missing data at the top, the top tile had the wrong magnification
}
...
volumeImgMontaged, groupNames, tileGroups = startMontage(
