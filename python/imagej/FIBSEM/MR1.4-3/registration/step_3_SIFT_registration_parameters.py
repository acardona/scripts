...
properties = {
 ...
 'n_threads': numCPUs(),
 'roi': [int(section_width / 4), # x      -  [x, y, width, height] or None. To e.g. extract SIFT features from center part only.
         int(section_height / 4), # y     NOTE: in full image resolution coordinates.
         int(section_width / 2), # width
         int(section_height / 2)], # height
...
paramsTileConfiguration = {
  ...
  "maxIterations": 2000, # Optimizer iterations for each chunk of chunk_size sections
