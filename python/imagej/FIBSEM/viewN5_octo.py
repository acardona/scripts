...
n5dir = "/net/zstore1/achampion/alignment/output/1120/v0/n5/FIBSEM_L1120_FullCNS_8x8x8nm/"
...
imp = wrap(img, title="octo")
imp.setSlice(3000)
imp2 = ImagePlus("octo slice 3000", imp.getProcessor())
imp2.show()
