...
# Can be None
model_path = "/net/zstore1/FIBSEM/MR1.4-2/registration/csv/labkit/classifier_MR1.4-2.classifier" # from LabKit
...
properties = {
 ...
 'shift_threshold': 2, # pixels, in world coordinates (not scaled)
 'n_threads': numCPUs(),
