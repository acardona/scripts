...
properties = {
 ...
 'filterFeaturesFn': makeFilterFeaturesFn(model_path, model_width, as3D=False) # Can be None for no filtering. Filter out features not in the tissue but in the resin, to ignore the resin which has streaks and curtains
}
...
paramsPMs = {
  'scale': properties.get('scale', 1), # compounds with montage interim_scale
